...
export default class Calculation extends React.Component<ICalculationProps, ICalculationStates>{
  ...
  getData = async () => {
    // 勞保
    await fetch("./react-labor-health-insurance/JSON/labor-grading.json")
      .then(res => res.json())
      .then(res => {
    ...
    // 健保
    await fetch("./react-labor-health-insurance/JSON/health-grading.json")
      .then(res => res.json())
      .then(res => {
        // console.log(res);
    ...
    // 勞退
    await fetch("./react-labor-health-insurance/JSON/pension-grading.json")
      .then(res => res.json())
      .then(res => {
        // console.log(res);
